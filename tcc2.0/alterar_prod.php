...
<form action="php_action/alterar_produto.php" method="POST">
  ...
  <div class="form-group">
    ...
    <button type="submit" name="btnExcluirProd" class="login-button">EXCLUIR</button>
    <button type="submit" name="voltar" class="login-button"><a href="estoque.php">VOLTAR</a></button>
  </div>
</form>
<?php
